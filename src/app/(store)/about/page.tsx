    ...
    <main>
      ...
      <section className="py-16 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="aspect-square rounded-none overflow-hidden" style={{ backgroundColor: 'var(--surface)' }}>
      ...
      <section className="py-16" style={{ backgroundColor: 'var(--cream)' }}>
        <div className="max-w-5xl mx-auto px-4 grid grid-cols-2 md:grid-cols-4 gap-6">
          {[['500+', 'Artisan Partners'], ['15+', 'Years of Excellence'], ['20+', 'States Served'], ['50,000+', 'Happy Customers']].map(([value, label]) => (
            <div key={label} className="bg-white rounded-none p-6 text-center shadow-sm border border-amber-100">
      ...
      <section className="py-16 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {[
            ...
            <div key={v.title} className="rounded-none p-6 border border-[var(--line)]" style={{ backgroundColor: 'var(--surface)' }}>
