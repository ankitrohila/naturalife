...
const PRODUCTS: ProductData[] = [
  ...
  { name: 'Yoga & Exercise Mat', sku: 'MT-004', category: 'mats', price: 899, wholesalePrice: 549, stock: 60, description: 'Thick non-slip yoga mat with alignment lines. 6mm cushioning, sweat-resistant surface, carry strap.', colors: ['blue', 'green', 'multi'], sizes: ['24x68', '24x72'] },
  ...
  { name: 'Ikat Woven Cushion Cover', sku: 'CC-004', category: 'cushion-covers', price: 449, wholesalePrice: 259, stock: 120, description: 'Traditional ikat-woven cushion cover with geometric motifs. Handmade in Pochampally, Telangana.', colors: ['red', 'multi', 'beige'], sizes: ['16x16', '18x18', '20x20'] },
  ...
  { name: 'PVC Non-Slip Table Mat', sku: 'TM-003', category: 'table-mats', price: 399, wholesalePrice: 229, stock: 200, description: 'Waterproof PVC dining mat with non-slip backing. Heat-resistant up to 100°C, easy wipe clean.', colors: ['black', 'grey', 'brown'], sizes: ['12x18', '14x20'] },

  // Stools
  { name: 'Upholstered Ottoman Stool', sku: 'ST-001', category: 'stools', price: 1499, wholesalePrice: 899, stock: 40, description: 'Padded ottoman stool with velvet upholstery and solid wooden legs. Multi-purpose as seating, footrest, or side table.', colors: ['grey', 'brown', 'black'], sizes: ['square', 'round'] },
  { name: 'Solid Wood Stool', sku: 'ST-002', category: 'stools', price: 999, wholesalePrice: 599, stock: 60, description: 'Handcrafted solid sheesham wood stool. Natural grain finish, strong mortise-tenon joints, lasts for decades.', colors: ['brown'], sizes: ['square', 'round'] },
  { name: 'Jute Rope Stool', sku: 'ST-003', category: 'stools', price: 1199, wholesalePrice: 749, stock: 35, description: 'Bohemian jute rope stool with mango wood frame. Natural fibres, sturdy base, artisan-made.', colors: ['beige', 'brown'], sizes: ['round'] },

  // Chef Mats
  { name: 'Professional Chef Anti-Fatigue Mat', sku: 'CM-001', category: 'chef-mats', price: 1299, wholesalePrice: 799, stock: 50, description: 'Commercial-grade anti-fatigue mat for professional kitchens. Bevelled edges, non-slip, grease-resistant, NSF certified.', colors: ['black', 'grey'], sizes: ['18x30', '24x36'] },
...
// Images from the public/images/products folder (already deployed to Vercel)
const PRODUCT_IMAGES = [
  ...
  '/images/products/p-sq-18.jpg',
  '/images/products/p-sq-19.jpg',
  '/images/products/p-sq-21.jpg',
  '/images/products/p-sq-22.jpg',
  '/images/products/p-sq-23.jpg',
  '/images/products/p-sq-24.jpg',
  '/images/products/p-sq-25.jpg',
  '/images/products/p-sq-26.jpg',
  '/images/products/p-sq-72.jpg',
  '/images/products/p-sq-73.jpg',
  '/images/products/p-sq-77.jpg',
...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    log.push(`✓ ${colors.length} colors created`)
    ...
    log.push(`✓ ${allSizes.length} sizes created`)
    ...
    for (const productData of PRODUCTS) {
      const product = await prisma.product.upsert({
        ...
        create: {
          ...
          description: productData.description,
          shortDesc: productData.description.substring(0, 80),
          status: 'ACTIVE',
          taxRate: 18,
          hsnCode: '6301',
          isFeatured: pIdx % 2 === 0,
      ...
      // Per-colour images (swap on colour select)
      ...
      // Variants: colour × size, price scales with size
      for (const color of productData.colors) {
        let sIdx = 0
        for (const size of productData.sizes) {
          ...
          const variant = await prisma.productVariant.upsert({
            ...
            create: { productId: product.id, sku: variantSku, price, wholesalePrice: wholesale, minWholesaleQty: 5, stock: productData.stock, weight: 0.5, attributeValues },
          })
    ...
    log.push(`✓ ${PRODUCTS.length} products with variants, images & bulk pricing`)
