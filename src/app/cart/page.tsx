            ...
            <div className="grid lg:grid-cols-3 gap-8">
              ...
              <div className="lg:col-span-2 space-y-4">
                {items.map((item) => {
                  ...
                  return (
                    <div key={item.variantId} className="bg-white rounded-xl p-4 border border-gray-100 flex gap-4">
              ...
              <div className="bg-white rounded-2xl p-6 border border-gray-100 h-fit sticky top-24">
                ...
                <Link href="/checkout" className="mt-5 block w-full py-3 text-center text-white rounded-xl font-semibold" style={{ backgroundColor: 'var(--saffron)' }}>
                  Proceed to Checkout
                </Link>
