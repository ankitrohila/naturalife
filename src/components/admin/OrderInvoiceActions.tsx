    ...
    <div className="bg-white rounded-xl shadow-sm border border-[var(--line)] p-5">
      ...
      <div className="flex flex-col gap-2">
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="w-full text-center py-2.5 rounded-lg border border-[var(--line)] text-sm font-medium text-[var(--ink)] hover:bg-[var(--surface)]"
        >
          View Invoice
        </a>
        <button
          ...
          disabled={sending}
          className="w-full py-2.5 rounded-lg border border-[var(--green)] text-sm font-semibold text-[var(--green)] hover:bg-[var(--green-light)] disabled:opacity-60"
        >
